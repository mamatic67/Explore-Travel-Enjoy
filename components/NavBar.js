...
function NavBar() {
    ...
    return (
        <div >
             <nav className='bg-slate-200 h-32'>
                <div className=''>
                    <div className=''>   
                            ...
                            <div className="hidden md:block ">
								...
								<div className="text-center mt-7 items-baseline space-x-10">
									<Link href="/">
										<a className=" cursor-pointer hover:bg-blue-600 text-black hover:text-white px-3 py-2 rounded-md text-xl font-medium">HOME</a>
									</Link>
									<Link href="/trips">
										<a className="cursor-pointer hover:bg-blue-600 text-black hover:text-white px-3 py-2 rounded-md text-xl font-medium">TRIPS</a>
									</Link>
									<Link href="/travels">
										<a className="cursor-pointer hover:bg-blue-600 text-black hover:text-white px-3 py-2 rounded-md text-xl font-medium">TRAVELS</a>
									</Link>
									<Link href="/blog">
										<a className="cursor-pointer hover:bg-blue-600 text-black hover:text-white px-3 py-2 rounded-md text-xl font-medium">BLOG</a>
									</Link>
									<Link href="/about">
										<a className="cursor-pointer hover:bg-blue-600 text-black hover:text-white px-3 py-2 rounded-md text-xl font-medium">ABOUT US</a>
									</Link>
									<Link href="/login">
										<a className="cursor-pointer hover:bg-blue-600 text-black hover:text-white px-3 py-2 rounded-md text-xl font-medium">LOGIN</a>
									</Link>
									</div>
